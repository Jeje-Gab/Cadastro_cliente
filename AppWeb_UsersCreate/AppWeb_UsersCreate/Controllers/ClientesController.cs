...
namespace AppWeb_UsersCreate.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Contato,Email")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Contato,Email")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
